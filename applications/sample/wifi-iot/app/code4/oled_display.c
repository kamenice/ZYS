...
void Display_Update(void)
{
    ...
    /* Line 1: Item presence (simplified - no weight) */
    int itemPresent = HX711_IsItemPresent();
    snprintf(line, sizeof(line), "Item: %s        ", 
             itemPresent ? "YES" : "NO ");
    ...
    snprintf(line, sizeof(line), "Speed:%u RPM    ", (unsigned int)rpm);
